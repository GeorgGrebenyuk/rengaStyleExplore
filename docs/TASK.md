...
> Сведения о путях к данным (а также именах файлов) 

| Name  | Type    | Description              | Comment               |
| ----- | ------- | ------------------------ | --------------------- |
| rowid | INTEGER | Индекс строки            | NOT NULL, PRIMARY KEY |
| path  | TEXT    | Абсолютный файловый путь | NOT NULL              |
| ext   | INTEGER | = FileExtensionVariant   | NOT NULL              |

## 2.2 Таблица extensions
...
> Изображения объектов (PNG картинки)

| Name       | Type    | Description                           | Comment               |
| ---------- | ------- | ------------------------------------- | --------------------- |
| rowid      | INTEGER | Индекс строки                         | NOT NULL, PRIMARY KEY |
| data       | BLOB    | Двоичное содержимое файла изображения | NOT NULL              |
| resolution | INTEGER | Разрешение снимка                     |                       |
...
| ----- | ------- | -------------------------------- | --------------------- |
| rowid | INTEGER | Индекс строки                    | NOT NULL, PRIMARY KEY |
| data  | BLOB    | Двоичное представление файла OBJ | NOT NULL              |
