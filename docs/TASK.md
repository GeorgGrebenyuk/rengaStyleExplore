...
| rowid       | INTEGER | Индекс строки                                                               | NOT NULL, PRIMARY KEY         |
| mode        | INTEGER | 0 -- по локальным файлам; 1 - по BLOB-записям;                              | NOT NULL, проверка на 0 или 1 |
| geom_rowid  | INTEGER | Идентификатор из таблицы paths или bindata для файла описания геометрии lua |                               |
| props_rowid | INTEGER | Идентификатор из таблицы paths или bindata для файла описания свойств json  |                               |
| rst_rowid   | INTEGER | Идентификатор из таблицы paths или bindata для готового файла стиля RST     |                               |
